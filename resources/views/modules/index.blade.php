    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 opacity-0 animate-fade-in delay-100">
        @forelse($modules as $modul)
            <div
                ...
                <div class="px-6 pb-4 pt-1 flex items-center space-x-4 text-xs font-bold text-gray-400">
                    <span class="flex items-center" title="Total Dilihat">
                    ...
                    <span class="flex items-center" title="Total Diunduh">
                        <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path>
                        </svg>
                        {{ $modul->downloads_count }}x
                    </span>
                </div>
